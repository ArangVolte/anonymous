...
async def handle_message(client, message):
    ...
    try:
        if message.photo:
            ...
            await client.send_photo(recipient_id, photo="https://akcdn.detik.net.id/community/media/visual/2022/11/18/simbol-bahan-kimia-5.jpeg?w=861", reply_markup=markup)
        else:
