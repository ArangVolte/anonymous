...
BOT_TOKEN = getenv("BOT_TOKEN", "6208650102:AAEjwqRpQqrpKLLw3hyVWqcTOW2bjAFjnjc")  # Pastikan untuk mengganti dengan nilai yang aman
...
MESSAGES = {
    ...
    "stop_message": "Anda telah menghentikan obrolan. tekan /next Mencari pasangan baru",
